...
import { z } from "zod";
import { diceRollSchema, parseDiceNotation, rollDice, rollResultSchema, } from "./dice.js";
import { packageJSON } from "./package.js";
const server = new McpServer({
    name: packageJSON.name,
    version: packageJSON.version,
});
server.registerTool("parse_dice_roll_notation", {
...
function setupExitWatchdog(transport) {
